...
| [`metallm.html`](metallm.html) | **Slide deck** | A companion 25-slide overview of **MetaLLM** (the ruv stack's domain-model layer — freeze one sovereign base and specialize it per domain with MicroLoRA + SONA, served on ruvLLM), in the same design system. |
